          ...
          .col-sm-12.col-md-10.col-lg-5.col-xl-3
            .row.justify-center
              .relative-position(style="max-width:380px;")
                distChart.cursor-pointer(v-scroll-reveal :percentages="categoryPercentages" :activeItem="activeItem" @selected="getSelected")
                .absolute-center(style="z-index:1; pointer-events:none;")
                  img.boidtoken.cursor-pointer(v-scroll-reveal style="pointer-events:none; user-select:none; width:300px;" @click="activeItem=null" src="~assets/NewBoidLogo.svg")
...
export default {
  ...
  data () {
    return {
      totalSupply: 25,
      activeItem:null,
      categories:['Airdrop', 'Team','Development','Ecosystem','Advisors','Marketing'],
      ...
      categoryPercentages:[20,5,10,30,5,30]
    }
  },
  methods:{
    openURL,
